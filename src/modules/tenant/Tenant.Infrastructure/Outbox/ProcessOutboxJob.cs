...
namespace Tenant.Infrastructure.Outbox;
...
{
    private const string ModuleName = ParentConstants.ModuleName;
            ...
            IDbTransaction transaction)
    {
        ...
        string sql =
            $"""
             ...
             FROM {ParentConstants.Schema}.outbox_messages
            ...
            Exception? exception)
    {
        ...
        const string sql =
            $"""
            UPDATE {ParentConstants.Schema}.outbox_messages
